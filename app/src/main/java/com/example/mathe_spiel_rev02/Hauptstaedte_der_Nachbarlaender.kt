...
class Hauptstaedte_der_Nachbarlaender : RobotActivity(), RobotLifecycleCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hauptstaedte_der_nachbarlaender)
    ...
    override fun onRobotFocusGained(qiContext: QiContext?) {
        ...
        topic = TopicBuilder.with(qiContext).withResource(R.raw.hauptstaedte).build()
        // Erstellen qiChatbot
