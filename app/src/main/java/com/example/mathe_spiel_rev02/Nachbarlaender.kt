...
class Nachbarlaender : RobotActivity(), RobotLifecycleCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nachbarlaender)
    ...
    override fun onRobotFocusGained(qiContext: QiContext?) {
        ...
        topic = TopicBuilder.with(qiContext).withResource(R.raw.nachbarlaender).build()
        // Erstellen qiChatbot
