...
class Bundeslaender : RobotActivity(), RobotLifecycleCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bundeslaender)
    ...
    override fun onRobotFocusGained(qiContext: QiContext?) {
        ...
        topic = TopicBuilder.with(qiContext).withResource(R.raw.bundeslaender).build()
        // Erstellen qiChatbot
